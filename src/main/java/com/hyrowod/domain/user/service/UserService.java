...
public class UserService {
    ...
    public UserDto updateMyInfo(String email,
            com.hyrowod.domain.user.dto.UserUpdateRequest request) {
    ...
    @Transactional
    public void changePassword(String email, com.hyrowod.domain.user.dto.PasswordChangeRequest request) {
        User user = getUserByEmail(email);
