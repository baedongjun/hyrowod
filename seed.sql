...
SELECT (SELECT id FROM users WHERE email = 'user1@hyrowod.com'),
...
SELECT '2026 HyroWOD Spring Open', '전국 크로스핏 선수들이 한자리에 모이는 봄 시즌 오픈 대회. RX 및 Scaled 부문으로 나뉘며 개인전과 팀전을 동시 진행합니다. 서울 최대 규모의 크로스핏 경기장에서 개최됩니다.', '2026-04-05', '2026-04-06', '서울특별시 강남구 테헤란로 456 COEX 홀', '서울', '2026-03-25', 'https://hyrowod.com/register', 'HyroWOD', 'RX', 'OPEN', 200, 50000, true, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM competitions WHERE name = '2026 HyroWOD Spring Open');
...
INSERT INTO competitions (name, description, start_date, end_date, location, city, registration_deadline, registration_url, organizer, level, status, max_participants, entry_fee, active, created_at, updated_at)
SELECT '2026 HyroWOD Open (온라인)', 'CrossFit Open 형식의 온라인 대회. 전국 어디서나 참가 가능하며, 3주간 매주 1개씩 WOD가 공개됩니다. 각 박스에서 영상 촬영 후 제출하는 방식으로 진행됩니다.', '2026-03-01', '2026-03-21', '전국 온라인 (각 소속 박스)', '서울', '2026-03-05', 'https://hyrowod.com/online-open', 'HyroWOD', 'ALL', 'CLOSED', 1000, 15000, true, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM competitions WHERE name = '2026 HyroWOD Open (온라인)');
...
INSERT INTO competitions (name, description, start_date, end_date, location, city, registration_deadline, registration_url, organizer, level, status, max_participants, entry_fee, active, created_at, updated_at)
SELECT '대전 CrossFit Championships 2026', '충청권 대표 크로스핏 대회. 대전·세종·충남·충북 선수들이 참여하는 지역 챔피언십입니다. 우승자에게는 HyroWOD 전국 대회 시드권을 부여합니다.', '2026-05-03', '2026-05-03', '대전광역시 유성구 대학로 99 충남대학교 체육관', '대전', '2026-04-20', 'https://daejeon-cf-champs.kr', '충청 크로스핏 협회', 'RX', 'UPCOMING', 120, 45000, true, NOW(), NOW()
